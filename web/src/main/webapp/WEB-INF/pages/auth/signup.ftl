...
<@base.page title="SignUp" css=["header", "content"] js=["main-module", "auth-module"]
        ...
        <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group"
                  ...
                  <span ng-show="signupForm.firstName.$error.minlength || signupForm.firstName.$error.maxlength"
                     class="help-block">firstName 5-50 characters</span>
                </div>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="form-group"
                  ...
                  <span ng-show="signupForm.lastName.$error.minlength || signupForm.lastName.$error.maxlength"
                     class="help-block">lastName 5-50 characters</span>
                </div>
              </div>
            </div>
          <#--<div class="form-group"-->
          ...
          <#--</div>-->
            <div class="form-group"
              ...
              <span ng-show="signupForm.email.$invalid && !signupForm.email.$pristine"
          ...
          <#--</div>-->
            <div class="form-group">
              ...
              <span ng-show="signupForm.password.$invalid && !signupForm.password.$pristine"
                 class="help-block">Password 8-50</span>
            </div>
          <#--<div class="row">-->
          ...
          <#--</div>-->
            ...
            <div class="row">
              ...
              <#--<input type="submit" value="Register" class="btn btn-primary btn-block btn-lg">-->
                <input type="submit" class="col-md-5 btn-lg btn btn-default pull-right"
                       ng-disabled="signupForm.$invalid" name="submit"
                       value="Register"/>
              </div>
