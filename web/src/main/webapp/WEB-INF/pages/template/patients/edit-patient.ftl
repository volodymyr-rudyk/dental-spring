      ...
      <div ng-controller="EditPatientController as epCtrl">
        <div class="row">
          <div class="col-xs-12 col-sm-8 col-md-9">
            <form role="form" ng-submit="epCtrl.update(editPatientForm.$valid)" name="editPatientForm" novalidate>
              <h3>New Patient</h3>
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6">
                  <div class="form-group"
                    ...
                    <p ng-show="editPatientForm.firstName.$error.minlength || editPatientForm.firstName.$error.maxlength"
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                  <div class="form-group"
                    ...
                    <p ng-show="editPatientForm.middleName.$error.minlength || editPatientForm.middleName.$error.maxlength"
              ...
              <div class="row">
                <div class="col-xs-12 col-md-12">
                  <input type="submit" class="col-md-5 btn-md btn btn-success pull-right"
                         ng-disabled="editPatientForm.$invalid" name="submit"
                         value="Add"/>
                </div>
              </div>
            </form>
