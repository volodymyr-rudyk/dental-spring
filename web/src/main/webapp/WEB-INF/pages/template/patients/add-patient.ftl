              ...
              <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6">
                  <div class="form-group"
                    ...
                    <input type="text" name="firstName" ng-model="user.firstName" class="form-control input-md"
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                  <div class="form-group"
                    ...
                    <input type="text" name="lastName" ng-model="user.lastName" class="form-control input-md"
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                  <div class="form-group"
                    ...
                    <input type="text" name="middleName" ng-model="user.middleName" class="form-control input-md"
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                  <div class="form-group"
                    ...
                    <input type="date" name="birthday" ng-model="user.birthday" class="form-control input-md"
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                  <div class="form-group"
                    ...
                    <input type="text" name="address" ng-model="user.address" class="form-control input-md"
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                  <div class="form-group"
                    ...
                    <select name="gender" ng-model="user.gender" class="form-control input-md"
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                  <div class="form-group"
                    ...
                    <input type="phone" name="phone" ng-model="user.phone" class="form-control input-md"
